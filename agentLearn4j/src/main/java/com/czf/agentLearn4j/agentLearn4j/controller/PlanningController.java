...
/**
 * Planning Controller
 * REST endpoints for planning agent
 */
@Slf4j
@RestController
@RequestMapping(ApiConstants.PLANNING_PATH)
...
public class PlanningController {
    ...
    @PostMapping("/plan")
    public ApiResponse<AgentResponse> plan(@RequestBody AgentRequest request) {
        log.info("Planning request: {}", request);
        AgentResponse response = agentService.executeAgent("planning", request.getInput());
